...
const Footer = () => {
  ...
  return (
    <footer className=" w-full">
      <div className="mt-8 py-8 px-3 xl:px-56 bg-gray-100 grid grid-cols-12 gap-2 lg:hidden">
      ...
      <div className="mt-8 py-8 px-3 xl:px-56 bg-gray-100 grid-cols-12 gap-2 hidden lg:grid">
        <aside className="col-span-12 sm:col-span-6 lg:col-span-3 mt-4 lg:mt-0  cursor-pointer">
